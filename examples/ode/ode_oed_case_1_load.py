...
designer_1.load_state('/ode_oed_case_1_pyomo_result/date_2020-4-6/state_1.pkl')

""" loading sensitivity values from previous run """
designer_1.load_sensitivity('/ode_oed_case_1_pyomo_result/date_2020-4-6/sensitivity_1.pkl')
